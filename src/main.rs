...
fn main() {
    ...
    println!(
        "{:?} Stats, Strength: {:?}",
        all_classes[0].class_name.to_string(),
        all_classes[0].strength.to_string()
    );
    println!(
        "{:?} Stats, Strength: {:?}",
        all_classes[1].class_name.to_string(),
        all_classes[1].strength.to_string()
    );
    println!(
        "{:?} Stats, Strength: {:?}",
        all_classes[2].class_name.to_string(),
        all_classes[1].strength.to_string()
    );
